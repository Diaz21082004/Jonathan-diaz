 ...
 */
function healthyfitnessgym_sanitize_checkbox( $checked ) {
	// Boolean check.
...
function healthyfitnessgym_switch_sanitization( $input ) {
    if ( true === $input ) {
        return 1;
    } else {
        return 0;
...
function healthyfitnessgym_sanitize_choices( $input, $setting ) {
    global $wp_customize; 
...
function healthyfitnessgym_sanitize_float( $input ) {
 ...
 */
function healthyfitnessgym_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function healthyfitnessgym_sanitize_html( $html ) {
 ...
 */
function healthyfitnessgym_sanitize_image( $image, $setting ) {
 ...
 */
function healthyfitnessgym_sanitize_nohtml( $nohtml ) {
 ...
 */
function healthyfitnessgym_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function healthyfitnessgym_sanitize_range_value( $number, $setting ) {
 ...
 */
function healthyfitnessgym_sanitize_select( $input, $setting ) {
 ...
 */
function healthyfitnessgym_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function healthyfitnessgym_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function healthyfitnessgym_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
