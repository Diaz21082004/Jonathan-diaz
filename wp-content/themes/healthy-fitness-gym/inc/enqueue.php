...
add_action( 'customize_controls_enqueue_scripts', function() {
	...
	wp_enqueue_script(
		'healthyfitnessgym-customize-section-button',
	...
	wp_localize_script(
		'healthyfitnessgym-customize-section-button',
		'healthyfitnessgym_customizer_params',
		array( 
 ...
 */
function healthy_fitness_gym_scripts() {
	...
	wp_enqueue_style('healthyfitnessgym-editor-style',get_template_directory_uri().'/assets/css/editor-style.css');

	wp_enqueue_style('healthyfitnessgym-main', get_template_directory_uri() . '/assets/css/main.css');

	wp_enqueue_style('healthyfitnessgym-woo', get_template_directory_uri() . '/assets/css/woo.css');
	
	wp_enqueue_style( 'healthyfitnessgym-style', get_stylesheet_uri() );
	...
	wp_enqueue_script('healthyfitnessgym-custom-js', get_template_directory_uri() . '/assets/js/theme.js', array('jquery'), false, true);

	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}
}
add_action( 'wp_enqueue_scripts', 'healthy_fitness_gym_scripts' );
