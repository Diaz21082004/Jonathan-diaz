<?php
	...
	$ecommerce_watch_store_grid_featured_image_box_shadow = get_theme_mod('ecommerce_watch_store_grid_featured_image_box_shadow',0);
	if($ecommerce_watch_store_grid_featured_image_box_shadow != false){
		$ecommerce_watch_store_custom_css .='.grid-post-main-box .box-image img, .grid-post-main-box .feature-box img, #content-vw img{';
			$ecommerce_watch_store_custom_css .='box-shadow: '.esc_attr($ecommerce_watch_store_grid_featured_image_box_shadow).'px '.esc_attr($ecommerce_watch_store_grid_featured_image_box_shadow).'px '.esc_attr($ecommerce_watch_store_grid_featured_image_box_shadow).'px #cccccc;';
		$ecommerce_watch_store_custom_css .='}';
	}

	$ecommerce_watch_store_grid_featured_image_border_radius = get_theme_mod('ecommerce_watch_store_grid_featured_image_border_radius', 0);
	if($ecommerce_watch_store_grid_featured_image_border_radius != false){
		$ecommerce_watch_store_custom_css .='.grid-post-main-box .box-image img, .grid-post-main-box .feature-box img, #content-vw img{';
			$ecommerce_watch_store_custom_css .='border-radius: '.esc_attr($ecommerce_watch_store_grid_featured_image_border_radius).'px;';
		$ecommerce_watch_store_custom_css .='}';
	}
	...
	$ecommerce_watch_store_theme_lay = get_theme_mod( 'ecommerce_watch_store_footer_template','ecommerce_watch_store-footer-one');
    if($ecommerce_watch_store_theme_lay == 'ecommerce_watch_store-footer-one'){
		$ecommerce_watch_store_custom_css .='#footer{';
			$ecommerce_watch_store_custom_css .='';
		$ecommerce_watch_store_custom_css .='}';

	}else if($ecommerce_watch_store_theme_lay == 'ecommerce_watch_store-footer-two'){
		$ecommerce_watch_store_custom_css .='#footer{';
			$ecommerce_watch_store_custom_css .='background: linear-gradient(to right, #f9f8ff, #dedafa);';
		$ecommerce_watch_store_custom_css .='}';
		$ecommerce_watch_store_custom_css .='#footer p, #footer li a, #footer, #footer h3, #footer a.rsswidget, #footer #wp-calendar a, .copyright a, #footer .custom_details, #footer ins span, #footer .tagcloud a, .main-inner-box span.entry-date a, nav.woocommerce-MyAccount-navigation ul li:hover a, #footer ul li a, #footer table, #footer th, #footer td, #footer caption, #sidebar caption,#footer nav.wp-calendar-nav a,#footer .search-form .search-field{';
			$ecommerce_watch_store_custom_css .='color:#000;';
		$ecommerce_watch_store_custom_css .='}';
		$ecommerce_watch_store_custom_css .='#footer ul li::before{';
			$ecommerce_watch_store_custom_css .='background:#000;';
		$ecommerce_watch_store_custom_css .='}';
		$ecommerce_watch_store_custom_css .='#footer table, #footer th, #footer td,#footer .search-form .search-field,#footer .tagcloud a{';
			$ecommerce_watch_store_custom_css .='border: 1px solid #000;';
		$ecommerce_watch_store_custom_css .='}';

	}else if($ecommerce_watch_store_theme_lay == 'ecommerce_watch_store-footer-three'){
		$ecommerce_watch_store_custom_css .='#footer{';
			$ecommerce_watch_store_custom_css .='background: #232524;';
		$ecommerce_watch_store_custom_css .='}';
	}
	else if($ecommerce_watch_store_theme_lay == 'ecommerce_watch_store-footer-four'){
		$ecommerce_watch_store_custom_css .='#footer{';
			$ecommerce_watch_store_custom_css .='background: #f7f7f7;';
		$ecommerce_watch_store_custom_css .='}';
		$ecommerce_watch_store_custom_css .='#footer p, #footer li a, #footer, #footer h3, #footer a.rsswidget, #footer #wp-calendar a, .copyright a, #footer .custom_details, #footer ins span, #footer .tagcloud a, .main-inner-box span.entry-date a, nav.woocommerce-MyAccount-navigation ul li:hover a, #footer ul li a, #footer table, #footer th, #footer td, #footer caption, #sidebar caption,#footer nav.wp-calendar-nav a,#footer .search-form .search-field{';
			$ecommerce_watch_store_custom_css .='color:#000;';
		$ecommerce_watch_store_custom_css .='}';
	...
	else if($ecommerce_watch_store_theme_lay == 'ecommerce_watch_store-footer-five'){
		$ecommerce_watch_store_custom_css .='#footer{';
			$ecommerce_watch_store_custom_css .='background: linear-gradient(to right, #01093a, #2d0b00);';
		$ecommerce_watch_store_custom_css .='}';
	}

	/*---------------- Footer Settings ------------------*/

	$ecommerce_watch_store_button_footer_heading_letter_spacing = get_theme_mod('ecommerce_watch_store_button_footer_heading_letter_spacing',1);
	$ecommerce_watch_store_custom_css .='#footer h3, a.rsswidget.rss-widget-title{';
		$ecommerce_watch_store_custom_css .='letter-spacing: '.esc_attr($ecommerce_watch_store_button_footer_heading_letter_spacing).'px;';
	$ecommerce_watch_store_custom_css .='}';

	$ecommerce_watch_store_button_footer_font_size = get_theme_mod('ecommerce_watch_store_button_footer_font_size','30');
	$ecommerce_watch_store_custom_css .='#footer h3, a.rsswidget.rss-widget-title{';
		$ecommerce_watch_store_custom_css .='font-size: '.esc_attr($ecommerce_watch_store_button_footer_font_size).'px;';
	$ecommerce_watch_store_custom_css .='}';

	$ecommerce_watch_store_theme_lay = get_theme_mod( 'ecommerce_watch_store_button_footer_text_transform','Capitalize');
	if($ecommerce_watch_store_theme_lay == 'Capitalize'){
		$ecommerce_watch_store_custom_css .='#footer h3{';
			$ecommerce_watch_store_custom_css .='text-transform:Capitalize;';
		$ecommerce_watch_store_custom_css .='}';
	}
	if($ecommerce_watch_store_theme_lay == 'Lowercase'){
	...
	$ecommerce_watch_store_footer_heading_weight = get_theme_mod('ecommerce_watch_store_footer_heading_weight','600');
	if($ecommerce_watch_store_footer_heading_weight != false){
		$ecommerce_watch_store_custom_css .='#footer h3, a.rsswidget.rss-widget-title{';
			$ecommerce_watch_store_custom_css .='font-weight: '.esc_attr($ecommerce_watch_store_footer_heading_weight).';';
		$ecommerce_watch_store_custom_css .='}';
	}